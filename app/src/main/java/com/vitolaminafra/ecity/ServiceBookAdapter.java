...
public class ServiceBookAdapter extends RecyclerView.Adapter<ServiceBookAdapter.ViewHolder> {
    ...
    public ServiceBookAdapter(List<ServiceView> list, Context context) {
        this.list = list;
